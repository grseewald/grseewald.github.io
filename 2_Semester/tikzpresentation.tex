...
\framesubtitle{\textbackslash usetikzlibrary\{shapes\}}
...
%%%% VENN DIAGRAM %%%
\begin{frame}[fragile]{Venn-diagram}

\begin{center}
\begin{tikzpicture}[fill=teal]
\scope
\clip (1,0) circle (1);
\fill (0,0) circle (1);
\endscope
...
\footnotesize{\url{https://www.bu.edu/math/files/2013/08/tikzpgfmanual.pdf}}, p. 116
...
Her er noe tekst med en «in line» Ti\textit{k}Z-figur \tikz{\draw[fill=cyan]  circle(0.2);}, og her er noe tekst etterpå.
